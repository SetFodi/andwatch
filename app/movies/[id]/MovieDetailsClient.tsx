...
// Properly type the props this component expects
interface MovieDetailsClientProps {
  id: string;
  movie: any; // The movie data fetched from the server
  userWatchItem: any | null; // The user's watch item data if logged in
  session: boolean; // If the user is logged in or not
}
